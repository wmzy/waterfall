(function($) {
	...
	// 瀑布流
	$.fn.waterfall = function(getElements) {
		var pq = new PriorityQueue(function (inQ, objToAdd) {
			return $(inQ).height() > $(objToAdd).height();
		});
		
		this.children("div").each(function () {
			pq.offer(this);
		});
		var elems = getElements().forEach(function (e) {
			var t = pq.poll();
			$(t).append(e);
			pq.offer(t);
		});
